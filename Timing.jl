...
# ╔═╡ fb2680bb-5841-4686-b73e-ef7c563f2f11
begin
	### A Pluto.jl notebook ###
	# v0.19.9
...
begin 
	using PlutoUI,ExtendableGrids,ExtendableSparse,ForwardDiff,PyPlot,LinearAlgebra, SparseArrays,VoronoiFVM,GridVisualize, PlutoVista
...
# ╔═╡ efe0fa0e-d508-4cf8-a2d6-37d74b9cb743
function ff(n)
...
# ╔═╡ 3efea6b3-b6cd-4053-bcc8-f87762197e88
...
function ff_ela()
	...
	f(2)
  for n=10:10:200
	t=minimum([@elapsed ff(n) for i=1:20])
	  push!(times,t)
  end
	times
end

# ╔═╡ a999b74b-7f06-4a87-aa3c-f9007fdfbf53
ff_ela()
...
# ╔═╡ 6615469e-1a80-4630-9869-42331076b121
t_bela=bela()
